...
mix.js('resources/js/app.js', 'public/js')
    ...
    .js('resources/js/bookingHistory.booking.js', 'public/js')
    .js('resources/js/admin.shipments.index.js', 'public/js')
    ...
    .sass('resources/sass/admin.shipments.index.scss', 'public/css')
    .sass('resources/sass/bookingHistory.booking.scss', 'public/css');
